...
public class Hier{
	public static void main(String args[]){
		...
		System.out.println("OFFICER: Name: "+o1.name+",Age: "+o1.age+", phNo: "+o1.phNo+", Address: "+o1.address+", Salary: "+o1.salary);
		System.out.println("MANAGER: Name: "+m1.name+",Age: "+m1.age+", phNo: "+m1.phNo+", Address: "+m1.address+", Salary: "+m1.salary);
	}
}
